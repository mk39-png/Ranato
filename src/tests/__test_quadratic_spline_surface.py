...
from src.utils.generate_shapes import generate_global_layout_grid
...
def test_quadratic_reproduction(u_curvature: float = 0.0,
    ...
    control_point_grid = generate_quadratic_grid(
        layout_point_grid, u_curvature, v_curvature, 0)
