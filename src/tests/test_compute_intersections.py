...
from src.core.common import (Matrix5x2f, Matrix5x3f, PlanarPoint1d, Vector5f,
...
@pytest.mark.filterwarnings("ignore:loadtxt")
def test_prune_intersection_points_spot_control() -> None:
    """
...
@pytest.mark.filterwarnings("ignore:loadtxt")
def test_compute_bezier_clipping_planar_curve_intersections_spot_control() -> None:
    """
...
@pytest.mark.filterwarnings("ignore:loadtxt")
def test_compute_planar_curve_intersections_spot_control() -> None:
    """
