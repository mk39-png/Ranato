...
from src.core.common import (Matrix3x3f, MatrixNx3f, PatchIndex,
...
def test_compute_spline_surface_boundaries_spot_control() -> None:
    ...
    compare_eigen_numpy_matrix(filepath+"boundary_patch_indices.csv", np.array(boundary_patch_indices))
