...
class VertexManifoldChart:
    ...
    todo("TODO: below is going to make these class variables accessible across ALL VertexManifoldChart objects...")
    ...
    def __init__(*args, **kwargs)
       vertex_index: int,  # Index of the vertex in the affine manifold
        ...
        is_boundary = False,  # Mark boundary vertices
        is_cone = False,  # Mark cone vertices
        is_cone_adjacent = False,  # Mark vertices adjacent to a cone
    ) -> None:
    todo()

        self.vertex_index: int,  # Index of the vertex in the affine manifold

        self.vertex_one_ring: list[int],
        self.  # List of manifold face indices in the one ring
        self.face_one_ring: list[int],
        self.  # Local uv coordinates of the one ring vertices
        self.one_ring_uv_positions: np.ndarray,
        self.is_boundary = False,  # Mark boundary vertices
        self.is_cone = False,  # Mark cone vertices
        self.is_cone_adjacent = False,  # Mark vertices adjacent to a cone
